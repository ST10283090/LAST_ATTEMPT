...
namespace LAST_ATTEMPT.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,UserId,Quantity,TotalAmount,TransactionDate,Processed")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,UserId,Quantity,TotalAmount,TransactionDate,Processed")] Transaction transaction)
        {
